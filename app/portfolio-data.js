...
export const profileSummary = {
  name: 'Logeshwaran Inbaraj',
  headline: 'Strategy, Business Operations, Data Analytics and AI workflow automation professional.',
  location: 'Singapore',
  positioning:
    'Logeshwaran bridges business strategy, data intelligence and AI automation to solve operational challenges, uncover insights and enable faster leadership decisions.',
  contactEmail: 'messagelogesh@gmail.com',
  linkedin: 'https://www.linkedin.com/in/logeshwaran-inbaraj/',
};
